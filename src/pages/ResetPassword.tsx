    ...
    <div className="flex min-h-[80vh] items-center justify-center relative">
      ...
      >
        <div className="text-center mb-8">
          <div className="w-12 h-12 bg-gradient-to-tr from-emerald-500 to-emerald-700 rounded-xl mx-auto flex items-center justify-center shadow-lg shadow-emerald-200 mb-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              <input type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} className="w-full rounded-xl border border-slate-200/60 bg-white/50 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/50 transition-all pr-10" required placeholder="••••••••" />
          ...
          <motion.button 
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full rounded-xl bg-gradient-to-r from-emerald-600 to-emerald-700 p-3 text-sm font-bold text-white shadow-lg shadow-emerald-200 hover:shadow-emerald-300 transition-all mt-6 disabled:opacity-70">
